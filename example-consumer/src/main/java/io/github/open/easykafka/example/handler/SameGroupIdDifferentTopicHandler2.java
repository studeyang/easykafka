 ...
 */
@Slf4j
@EventHandler(cluster = "send", topics = "easykafka-example-topic2", groupId = "example-groupId")
public class SameGroupIdDifferentTopicHandler2 implements IEventHandler {

    @KafkaHandler
    public void handle(AnotherTopicEvent event) {
