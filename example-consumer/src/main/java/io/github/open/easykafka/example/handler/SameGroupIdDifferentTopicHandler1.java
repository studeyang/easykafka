 ...
 */
@Slf4j
@EventHandler(cluster = "send", topics = "easykafka-example-topic", groupId = "example-groupId")
public class SameGroupIdDifferentTopicHandler1 implements IEventHandler {
